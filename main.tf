# Dynamic Random Suffix Generator
...
# Standard Storage Account with Dynamic Suffix
resource "azurerm_storage_account" "sa" {
  name                     = "${var.storage_account_base_name}${random_string.suffix.result}"
...
# Modern Workspace-Based Application Insights Resource
